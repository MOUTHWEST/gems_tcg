...
cardlist = {
	...
	9:{title:'Green Shard',
		color:'green',
		cost:'G|G',
		desc:'Place a green stone in front of an existant green stone on the board.',},
	10:{title:'Jadeite Amulet',
		color:'green',
		cost:'G*G',
	...
	13:{title:'Win Condition',
		color:'white',
		cost:'BBB|GBG|GGG',
		desc:'If this pattern appears in the central 3x3 area, you win the game.',},
	14:{title:'Win Condition',
		color:'white',
		cost:'GRG|GRR|RGG',
		desc:'If this pattern appears in the central 3x3 area, you win the game.',},
	15:{title:'Win Condition',
		color:'white',
		cost:'RRR|BRB|RBR',
		desc:'If this pattern appears in the central 3x3 area, you win the game.',},
	16:{title:'Win Condition',
		color:'white',
		cost:'ROO|ORR|ROR',
		desc:'If this pattern appears in the central 3x3 area, you win the game.',},
	17:{title:'Win Condition',
		color:'white',
		cost:'OBO|BBB|BBO',
		desc:'If this pattern appears in the central 3x3 area, you win the game.',},
	18:{title:'Win Condition',
		color:'white',
		cost:'GBB|BBG|GBG',
		desc:'If this pattern appears in the central 3x3 area, you win the game.',},
	19:{title:'Win Condition',
		color:'white',
		cost:'GGO|OGO|OGO',
		desc:'If this pattern appears in the central 3x3 area, you win the game.',},
	20:{title:'Win Condition',
		color:'white',
		cost:'ROO|ORO|ORR',
		desc:'If this pattern appears in the central 3x3 area, you win the game.',},
};
...
function save_card(card){
	...
	let cmap = {
		...
		'O': [0,0,0,0,0].map(function(x){return 'rgb(' + colorlist.yellow[x].join(',') + ')'}),
